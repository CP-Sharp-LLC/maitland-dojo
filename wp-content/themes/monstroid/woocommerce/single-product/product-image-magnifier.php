	...
	if ( has_post_thumbnail() ) {
		...
		if ( $attachment_ids ) {
			echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '
				<div class="zoom"><a href="return: false;" id="open-gallery-popup"><i class="fa fa-arrows-alt"></i></a></div>
				<a itemprop="image" class="yith_magnifier_zoom woocommerce-main-image" href="%s" title="%s">%s</a>', $magnifier_url, $image_title, $image ), $post->ID );
		} else {
